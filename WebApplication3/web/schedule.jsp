  ...
  <!--==============================header=================================-->
    <header>
        ...
        <nav>  
            ...
            <ul class="menu">
                <li><a href="index1.html" class="clr-1">Home</a></li>
                <li><a href="about1.html" class="clr-2">About</a></li>
                <li class="current"><a href="schedule.jsp" class="clr-3">Schedule</a></li>
                <li><a href="gallery1.html" class="clr-4">Gallery</a></li>
                <li><a href="contacts1.html" class="clr-5">Contacts</a></li>
            </ul>
         </nav>
    </header>   
  <!--==============================content================================-->
